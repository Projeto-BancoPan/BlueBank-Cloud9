...
public class ClienteController {
    ...
    @GetMapping(value = "/endereco/{idCliente}")
    ...
    @GetMapping(value = "/contato/{idCliente}")
    ...
    @GetMapping(value = "/tipo_filtro/{tipoCliente}")
    ...
    @DeleteMapping(value = "/deletar/{idCliente}")
    ...
    @Transactional
    @RequestMapping(value = "/atualizar/{idCliente}", method = RequestMethod.PUT)
